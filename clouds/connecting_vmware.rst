...
* UnregisterVM_Task of Virtual Machines and Templates that are used by Scalr. Registering them back into Scalr will not resolve the issue as they servers and/or images will have a different UUID.
